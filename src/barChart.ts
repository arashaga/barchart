module powerbi.extensibility.visual {
    ...
    function visualTransform(options: VisualUpdateOptions, host: IVisualHost): BarChartViewModel {
        ...
        // if dataset is not empty or dataset's first item is not emtpy or....return datasets otherwise 
        //create the dataset and then return it
        if (!dataViews
            || !dataViews[0]
        ...
        let barChartSettings: BarChartSettings = {
            enableAxis: {
                //getValue is a generic function to return the settings or the default value set in defaultseeting
                // of visualtransform
    ...
    export class BarChart implements IVisual {
        ...
        constructor(options: VisualConstructorOptions) {
            ...
            //create a selection manager that manges if anything is selected in the bar chart
            ...
            //register a callback on the selections so you can response to the selection
            //for instance if a bar is selected you can show the tooltip
           ...
           this.textNode.textContent = ("Arash Mosharraf");

            //awesome function to create a link
            this.helpLinkElement = this.createHelpLinkElement();
            //append the link to the options.element that has svg already
         ...
         */
        @logExceptions()
        // when you want to upade you need to pass the refrence to all the stuff that needs to be updated 
        public update(options: VisualUpdateOptions) {
            console.log('updated!');
            debugger;
            //returns the updated BarCHartViewModel type
            //???? why is visualTransform opens.viewmodel is set and so forth?
            //is it changing the original object
